...
use app\models\HelperFixCsv;
use app\models\HelperLevoshkin;
//1200896
class UploadFixController extends Controller {
    ...
    public function processUpload($upload) {
        ...
        foreach ($bInfo as $index => $bookline) {
            ...
            $statInfo = HelperFixCsv::processBookCsv($book->id, $upload->id . "/$index.csv",$book->name);
	...
	public function actionIndex() {
        $uploads = BookUpload::find()->andWhere(['status' => 2])->all();
