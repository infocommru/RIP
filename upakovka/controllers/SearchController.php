...
class SearchController extends Controller {
    ...
    protected function searchCemetery($c_id) {
        ...
        if ($_GET['rip_style']) {
            ...
            switch ($rStyle) {
                case 2:
                    $query->andWhere("rip_style = $rStyle");
                    break;
                case 1:
                    $query->andWhere("rip_style = $rStyle");
                    break;
        ...
        if ($_GET['dead_year']) {
            $dead_year = intval($_GET['dead_year']);
        ...
        if (isset($_GET['ext_search'])) {
            ...
            if ($_GET['zags'] != '-1') {
                $query->andWhere(['zags_num' => $_GET['zags']]);
            }
