...
(function ($) {
    ...
    function Galereya(options) {
        ...
        var buildDOM = function () {
            ...
            $imgs.wrapAll('<div class="galereya-grid" />').each(function (i, img) {
                ...
                $img.addClass('galereya-cell-img')
                        .wrap('<div class="galereya-cell galereya-cell' + i + '" data-index="' + i + '"></div>')
                        .parent()
                        .append('<div class="galereya-cell-desc">\
        ...
        var createSlide = function (visibleIndex) {
            ...
            $slide = $('<div class="galereya-slider-slide aaa' + visibleIndex + '" />')
                    .html('<div class="galereya-slide-loader"></div>');

            var app_add = '<img class="galereya-slide-img" src="' + data[index].fullsrc + '" alt="' + data[index].title + '" />';
            $slide.append(app_add);
//$slide.html($img);
            //startSlideShow();
            /*
