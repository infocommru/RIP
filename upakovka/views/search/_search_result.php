                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < sizeof($list); $i++) {
                                ...
                                $fio = $elem['record']['fio'];
                                $age = $elem['record']['age'];
                                $dead_year = dat_format($elem['record']['death_date']);
                                $rip_year = dat_format($elem['record']['rip_date']);
                                $zags = \app\models\Helper::regionToText($elem['zags_num']);

                                if ($zags == '-')
                                    $zags = $elem['record']['zags'];
                                ...
                                $dopInfo = "<spac style='font-size:13px;'>св. $elem[svazka_num], кн. $elem[book_num], стр. $elem[page_num], индекс: $elem[page_punkt]";
                                if ($comment)
                                    $dopInfo .= "<br />$comment";
                                $dopInfo .= "</span>";
